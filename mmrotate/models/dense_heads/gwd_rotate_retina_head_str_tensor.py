...
class GWDRRetinaHead(RotatedRetinaHead):
    ...
    def __init__(self,
        ...
        super(GWDRRetinaHead, self).__init__(
    ...
    def _init_layers(self):
        ...
        super(GWDRRetinaHead, self)._init_layers()
    ...
    def _get_targets_single(self,
        ...
        if len(pos_inds) > 0:
            ...
            angle_targets[pos_inds, :] = a_t #/ torch.norm(a_t, dim=1, keepdim=True)
