...
data = dict( 
    train=dict(type='IcdarWSOODDataset', pipeline=train_pipeline, 
        ann_file=data_root + 'train_coco_format.json',
        img_prefix=data_root + 'train_images/',
            version=angle_version), 
    val=dict(type='IcdarWSOODDataset', pipeline=test_pipeline, 
        ann_file=data_root + 'test_coco_format.json',
        img_prefix=data_root + 'test_images/',
            version=angle_version), 
    test=dict(type='IcdarWSOODDataset', pipeline=test_pipeline, 
        ann_file=data_root + 'test_coco_format.json',
        img_prefix=data_root + 'test_images/',
            version=angle_version)) 
